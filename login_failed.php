...
<div id="wrapper" >
  ...
  <div id="footer" style="margin-left:150px">
    ...
    <form action="login.exec_candidate.php" method="get" name="LoginForm">
 
<table class="form" cellpadding="10" align="center">
 
<tr class="head">
<td colspan="2" align="center"><label style="color:#F00"><b>LOGIN FAILED.</br> PLEASE check your credential!!!!! </b></td>
</tr>
 
<tr>
<td><label  style="color:#FF0"for="uname"><b>Email: </b></label></td>
 
<td><input type="text" name ="email" id="uname" size="20" maxlength ="15"> </td>
</tr>
 
<tr>
<td><label style="color:#FF0" for="pwd"><b>Password:</b> </label></td>
 
<td><input type="password" name ="pwd" id="pwd" size="20" maxlength ="15"></td>
</tr>
...
<br/>
    <p>&nbsp;</p>
    <p>COPYRIGHT (C) 2011 MAVIN $ JOAN. ALL RIGHTS RESERVED</p>
  </div>
