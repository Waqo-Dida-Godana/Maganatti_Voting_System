...
<div id="wrapper" >
  ...
  <div id="footer" style="margin-left:150px">
    ...
    <form action="login_exec.php" method="get" name="LoginForm">
...
<td><input type="text" name ="email" id="uname" size="20" maxlength ="15" required =""/> </td>
</tr>
 
<tr>
<td><label style="color:#FF0" for="pwd"><b>Password:</b> </label></td>
 
<td><input type="password" name ="pwd" id="pwd" size="20" maxlength ="15" required =""/></td>
</tr>
